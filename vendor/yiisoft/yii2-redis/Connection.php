...
class Connection extends Component
{
    ...
    public $redisCommands = [
        'APPEND', //追加字符串 Append a value to a key
        'AUTH', //输入密码连接 Authenticate to the server
        ...
        'EXEC', //提交所有事物 Execute all commands issued after MULTI
        ...
        'HDEL', //删除一个或多个hash 字段 Delete one or more hash fields
        'HEXISTS', // Determine if a hash field exists
        'HGET', //查找一个hash字段 Get the value of a hash field
        'HGETALL', //查看所有hash字段 Get all the fields and values in a hash
        'HINCRBY', // Increment the integer value of a hash field by the given number
        'HINCRBYFLOAT', // Increment the float value of a hash field by the given amount
        'HKEYS', // Get all the fields in a hash
        'HLEN', //返回hash字段的个数 Get the number of fields in a hash
        'HMGET', //返回一个或多个hash字段的值 Get the values of all the given hash fields
        'HMSET', //设置一个或多个hash字段 Set multiple hash fields to multiple values
        'HSET', //设置一个hash字段 Set the string value of a hash field
        'HSETNX', //当这字段不存在时设置一个hash字段 Set the value of a hash field, only if the field does not exist
        'HSTRLEN', //返回hash字段长度 Get the length of the value of a hash field
        'HVALS', //返回hash所有值 Get all the values in a hash
        'INCR', // Increment the integer value of a key by one
        'INCRBY', // Increment the integer value of a key by the given amount
        'INCRBYFLOAT', // Increment the float value of a key by the given amount
        'INFO', // Get information and statistics about the server
        'KEYS', //查找所有redis key  Find all keys matching the given pattern
        ...
        'MGET', //返回多个字符串的值 Get the values of all the given keys
        'MIGRATE', // Atomically transfer a key from a Redis instance to another one.
        'MONITOR', // Listen for all requests received by the server in real time
        'MOVE', //从一个库移到另一个库 Move a key to another database
        'MSET', //设置多个值原子性 Set multiple keys to multiple values
